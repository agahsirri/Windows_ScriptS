...
"\\172.2.2.4\Software\ProgramS\AdobeCS4\Setup.exe" -mode=silent deploymentFile="\\172.2.2.4\Software\ProgramS\AdobeCS4\_UnattendedInstallerS\AdobeCS4_AcrobatPro_Photoshop\AdobeUberInstaller.xml"